        ...
        <div class="col-md-8 mx-auto">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{route('brands.index')}}" class="btn btn-info float-end">Manage</a>
                </div>
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('brands.update', $brands->id)}}">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-8">
                                <label><input type="radio" name="status" value="1" {{$brands->status == 1 ? 'checked' : ''}}>Published</label>
                                <label><input type="radio" name="status" value="0" {{$brands->status == 0 ? 'checked' : ''}}>Unpublished</label>
                            </div>
                        </div>
                        <div class="row mt-3">
